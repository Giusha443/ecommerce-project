...
@Component({
  ...
  template: `<mat-icon
    style="width: 2.9rem; display: inline-flex;"
    svgIcon="this-app-logo=icon"
    aria-hidden="false"
    aria-label="Home"></mat-icon>`,
...
export class LogoIconComponent {
  constructor() {
    ...
    iconRegistry.addSvgIconLiteral('this-app-logo=icon', sanitizer.bypassSecurityTrustHtml(OUR_APP_LOGO_ICON));
  }
}
